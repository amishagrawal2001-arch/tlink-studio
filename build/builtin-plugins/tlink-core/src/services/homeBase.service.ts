...
export class HomeBaseService {
    ...
    openGitHub (): void {
        this.platform.openExternal('https://github.com/Eugeny/tlink')
    }
    ...
    openTranslations (): void {
        this.platform.openExternal('https://translate.tlink.sh/project/tlink')
    }
    ...
    reportBug (): void {
        ...
        this.platform.openExternal(`https://github.com/Eugeny/tlink/issues/new?body=${encodeURIComponent(body)}`)
    }
