...
export { BottomPanelService, BottomPanelRegistration } from '../services/bottomPanel.service'
export { SidePanelService, SidePanelRegistration } from '../services/sidePanel.service'
