...
export declare abstract class ProfileProvider<P extends Profile> {
    id: string;
    name: string;
    ...
    duplicateProfile(source: P, target: P): Promise<void> | void;
}
export declare abstract class ConnectableProfileProvider<P extends ConnectableProfile> extends ProfileProvider<P> {
}
export declare abstract class QuickConnectProfileProvider<P extends ConnectableProfile> extends ConnectableProfileProvider<P> {
