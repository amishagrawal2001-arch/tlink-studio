...
export const configPath = path.join(process.env.TLINK_CONFIG_DIRECTORY!, 'config.yaml')
const legacyConfigPath = path.join(process.env.TLINK_CONFIG_DIRECTORY!, '../terminus', 'config.yaml')
