...
export class TaskCompletionContextMenu extends TabContextMenuItemProvider {
    ...
    async getItems (tab: BaseTabComponent): Promise<MenuItemOptions[]> {
        ...
        const extTab: (BaseTabComponent & { __completionNotificationEnabled?: boolean, __completionSubscription?: Subscription|null, __outputNotificationSubscription?: Subscription|null }) = tab
            ...
            items.push({
                ...
                click: () => {
                    ...
                    if (extTab.__completionNotificationEnabled) {
                        extTab.__completionSubscription?.unsubscribe()
                        extTab.__completionSubscription = this.app.observeTabCompletion(tab).subscribe(() => {
                            ...
                            extTab.__completionSubscription = null
                        })
                    } else {
                        extTab.__completionSubscription?.unsubscribe()
                        extTab.__completionSubscription = null
...
/** @hidden */
@Injectable()
export class ProfilesContextMenu extends TabContextMenuItemProvider implements OnDestroy {
    weight = 10
    ...
    constructor (
        ...
        super()
        this.hotkeySub = hotkeys.hotkey$.subscribe(hotkey => {
