...
import { HotkeysService, BaseComponent as CoreBaseComponent, Keystroke, ConfigService } from 'tlink-core'

// Fallback to a no-op base to avoid runtime crashes if the core export is unavailable
