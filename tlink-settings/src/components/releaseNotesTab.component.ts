...
import { BaseTabComponent as CoreBaseTabComponent, TranslateService } from 'tlink-core'

// Guard against missing core export to prevent startup crashes
...
export class ReleaseNotesComponent extends BaseTabComponent {
    ...
    async loadReleases (page) {
        ...
        const response = await axios.get(`https://api.github.com/repos/eugeny/tlink/releases?page=${page}`, {
