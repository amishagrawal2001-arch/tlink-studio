...
import { BaseTabProcess, WIN_BUILD_CONPTY_SUPPORTED, isWindowsBuild, GetRecoveryTokenOptions } from 'tlink-core'
...
export class TerminalTabComponent extends BaseTerminalTabComponent<LocalProfile> {
    ...
    async initializeSession (columns: number, rows: number): Promise<void> {
