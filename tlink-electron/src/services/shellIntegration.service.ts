...
export class ShellIntegrationService {
    private automatorWorkflows = ['Open Tlink here.workflow', 'Paste path into Tlink.workflow']
    private automatorWorkflowsLocation: string
    private automatorWorkflowsDestination: string
    private registryKeys = [
        {
            path: 'Software\\Classes\\Directory\\Background\\shell\\Tlink',
            value: 'Open Tlink here',
            command: 'open "%V"',
        },
        {
            path: 'SOFTWARE\\Classes\\Directory\\shell\\Tlink',
            value: 'Open Tlink here',
            command: 'open "%V"',
        },
        {
            path: 'Software\\Classes\\*\\shell\\Tlink',
            value: 'Paste path into Tlink',
            command: 'paste "%V"',
        },
    ]
    ...
    async install (): Promise<void> {
        ...
        if (this.hostApp.platform === Platform.macOS) {
            ...
            if (wnr.getRegistryKey(wnr.HK.CU, 'Software\\Classes\\Directory\\Background\\shell\\Open Tlink here')) {
                wnr.deleteRegistryKey(wnr.HK.CU, 'Software\\Classes\\Directory\\Background\\shell\\Open Tlink here')
            }
            if (wnr.getRegistryKey(wnr.HK.CU, 'Software\\Classes\\*\\shell\\Paste path into Tlink')) {
                wnr.deleteRegistryKey(wnr.HK.CU, 'Software\\Classes\\*\\shell\\Paste path into Tlink')
            }
        }
    }
