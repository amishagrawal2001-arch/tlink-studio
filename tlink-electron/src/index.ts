...
import { PTYInterface, ShellProvider, UACService } from 'tlink-local'
...
import { BundledFishShellProvider } from './shells/bundledFish'
...
@NgModule({
    providers: [
        ...
        // Optional: provides Fish when the binary is bundled in `extras/fish/...`
        { provide: ShellProvider, useClass: BundledFishShellProvider, multi: true },
